from chonkie import SDPMChunker, OverlapRefinery
...
if __name__=="__main__":
    ...
    with open("National_Parivar_Mediclaim_Plus_Policy.txt") as f:
        content=f.read()
    # def extract_text_from_docx(file_path: str) -> str:
    #     """
    #     Extracts and returns all text from a .docx file as a single string.
    #     """
    ...
    #     return "\n".join(full_text)
    # content=extract_text_from_docx("Mediclaim Insurance Policy.docx")
    ...
    #     results = table.search(query_type="hybrid").vector(query).text(single_query).limit(5).to_pandas()["text"].to_list()
    #     return results
